...
/**	
 * <br><a href="http://localhost:8983/solr/computate/select?q=*:*&fq=partEstClasse_indexed_boolean:true&fq=classeNomCanonique_enUS_indexed_string:org.computate.site.enus.vertx.MainVerticle">Find the class MainVerticle in Solr. </a>
 * <br><br>Delete the class MainVerticle in Solr. 
 * <br><pre>curl 'http://localhost:8983/solr/computate/update?commitWithin=1000&overwrite=true&wt=json' -X POST -H 'Content-type: text/xml' --data-raw '&lt;add&gt;&lt;delete&gt;&lt;query&gt;classeNomCanonique_enUS_indexed_string:org.computate.site.enus.vertx.MainVerticle&lt;/query&gt;&lt;/delete&gt;&lt;/add&gt;'</pre>
...
CREATE TABLE SiteUser(
	...
	, seeDeleted boolean
	, siteDomainName text
	, zookeeperVersion text
	, zookeeperPortClient integer
	, solrVersion text
	, solrPortClient integer
	, solrConfigset text
	, solrCollection text
	);
