...
public abstract class ArticleGen<DEV> extends Object {
	...
	public void setArticleCreated(Date o) {
		this.articleCreated = o == null ? null : ZonedDateTime.ofInstant(o.toInstant(), ZoneId.of(siteRequest_.getConfig().getString(ComputateConfigKeys.SITE_ZONE))).truncatedTo(ChronoUnit.MILLIS);
	}
	...
	public void setPageCreated(Date o) {
		this.pageCreated = o == null ? null : ZonedDateTime.ofInstant(o.toInstant(), ZoneId.of(siteRequest_.getConfig().getString(ComputateConfigKeys.SITE_ZONE))).truncatedTo(ChronoUnit.MILLIS);
	}
