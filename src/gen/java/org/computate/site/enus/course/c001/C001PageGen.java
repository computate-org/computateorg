 ...
 * <ol>
 * <li>You can add a class comment "{@inheritDoc}" if you wish to inherit the helpful inherited class comments from class C001PageGen into the class C001Page. 
 * </li>
 * <li>You can add a class comment <b>"Api: true"</b> if you wish to GET, POST, PATCH or PUT these C001Page objects in a RESTful API. 
 * </li>
 * </ol>
 * <h1>About the C001Page class and it's generated class C001PageGen&lt;C001GenPage&gt;: </h1>
 * <p>
