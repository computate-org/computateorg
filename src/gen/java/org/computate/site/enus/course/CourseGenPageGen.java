 ...
 * <h3>About the CourseGenPage class and it's generated class CourseGenPageGen&lt;ArticlePage&gt;: </h3>extends CourseGenPageGen
 * <p>
 * This Java class extends a generated Java class CourseGenPageGen built by the <a href="https://github.com/computate-org/computate">https://github.com/computate-org/computate</a> project. 
 ...
 * </p>
 * extends CourseGenPageGen<ArticlePage>
 * <p>This <code>class CourseGenPage extends CourseGenPageGen&lt;ArticlePage&gt;</code>, which means it extends a newly generated CourseGenPageGen. 
 * The generated <code>class CourseGenPageGen extends ArticlePage</code> which means that CourseGenPage extends CourseGenPageGen which extends ArticlePage. 
 ...
 * Indexed: true
 * {@inheritDoc}
 * <p>By adding a class comment "{@inheritDoc}", the CourseGenPage class will inherit the helpful inherited class comments from the super class CourseGenPageGen. 
 * </p>
 * Rows: null
 * Model: true
 * Page: true
 ...
 *   This means that the CourseGenPage Java class has promiseDeep methods which must be initialized asynchronously as a Vert.x Promise  instead of initDeep methods which are a simple non-asynchronous method. 
 * </p>
 * <p>
