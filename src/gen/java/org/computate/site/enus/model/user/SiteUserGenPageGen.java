...
/**	
<ol>
0<li>You can add a class comment "{@inheritDoc}" if you wish to inherit the helpful inherited class comments from class SiteUserGenPageGen into the class SiteUserGenPage. 
</li>
0<li>You can add a class comment <b>"Api: true"</b> if you wish to GET, POST, PATCH or PUT these SiteUserGenPage objects in a RESTful API. 
</li>
...
<p><a href="http://localhost:8983/solr/computate/select?q=*:*&fq=partEstClasse_indexed_boolean:true&fq=classeNomCanonique__indexed_string:org.computate.site.enus.model.user.SiteUserGenPage">Find the class SiteUserGenPage in Solr. </a></p>
<p>
...
0<h1>Suggestions that can generate more code for you: </h1>0<h1>About the SiteUserGenPage class and it's generated class SiteUserGenPageGen&lt;BaseModelPage&gt;: </h1><p>
...
curl 'http://localhost:8983/solr/computate/update?commitWithin=1000&overwrite=true&wt=json' -X POST -H 'Content-type: text/xml' --data-raw '&lt;add&gt;&lt;delete&gt;&lt;query&gt;classeNomCanonique__indexed_string:org.computate.site.enus.model.user.SiteUserGenPage&lt;/query&gt;&lt;/delete&gt;&lt;/add&gt;'
</p>
<p>
