...
import org.computate.site.enus.model.base.BaseModelGenPage;
...
/**	
 * <br><a href="http://localhost:8983/solr/computate/select?q=*:*&fq=partEstClasse_indexed_boolean:true&fq=classeNomCanonique_enUS_indexed_string:org.computate.site.enus.model.base.BaseModelPage">Find the class BaseModelPage in Solr. </a>
 * <br><br>Delete the class BaseModelPage in Solr. 
 * <br><pre>curl 'http://localhost:8983/solr/computate/update?commitWithin=1000&overwrite=true&wt=json' -X POST -H 'Content-type: text/xml' --data-raw '&lt;add&gt;&lt;delete&gt;&lt;query&gt;classeNomCanonique_enUS_indexed_string:org.computate.site.enus.model.base.BaseModelPage&lt;/query&gt;&lt;/delete&gt;&lt;/add&gt;'</pre>
