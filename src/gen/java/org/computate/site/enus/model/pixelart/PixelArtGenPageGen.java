 ...
 * </li>
 * <li>You can add a class comment "Api: true" if you wish to GET, POST, PATCH or PUT these PixelArtGenPage objects in a RESTful API. 
 * </li>
 * </ol>
...
public abstract class PixelArtGenPageGen<DEV> extends BaseModelPage {
	 ...
	 *  is defined as null before being initialized. 
	 * <br><a href="http://localhost:8983/solr/computate/select?q=*:*&fq=partEstEntite_indexed_boolean:true&fq=classeNomCanonique_enUS_indexed_string:org.computate.site.enus.model.pixelart.PixelArtGenPage&fq=entiteVar_enUS_indexed_string:pageResponse">Find the entity pageResponse in Solr</a>
	 * <br>
	 * @param w is for wrapping a value to assign to this entity during initialization. 
	 **/
	...
	public void setPageResponse(String o) {
		this.pageResponse = PixelArtGenPage.staticSetPageResponse(siteRequest_, o);
	}
	public static String staticSetPageResponse(SiteRequestEnUS siteRequest_, String o) {
		return o;
	}
	protected PixelArtGenPage pageResponseInit() {
	...
	public static String staticSearchFqPageResponse(SiteRequestEnUS siteRequest_, String o) {
		return PixelArtGenPage.staticSearchStrPageResponse(siteRequest_, PixelArtGenPage.staticSearchPageResponse(siteRequest_, PixelArtGenPage.staticSetPageResponse(siteRequest_, o)));
	}
	 ...
	 *  is defined as null before being initialized. 
	 * <br><a href="http://localhost:8983/solr/computate/select?q=*:*&fq=partEstEntite_indexed_boolean:true&fq=classeNomCanonique_enUS_indexed_string:org.computate.site.enus.model.pixelart.PixelArtGenPage&fq=entiteVar_enUS_indexed_string:defaultZoneId">Find the entity defaultZoneId in Solr</a>
	 * <br>
	 * @param w is for wrapping a value to assign to this entity during initialization. 
	 **/
	...
	public void setDefaultZoneId(String o) {
		this.defaultZoneId = PixelArtGenPage.staticSetDefaultZoneId(siteRequest_, o);
	}
	public static String staticSetDefaultZoneId(SiteRequestEnUS siteRequest_, String o) {
		return o;
	}
	protected PixelArtGenPage defaultZoneIdInit() {
	...
	public static String staticSearchFqDefaultZoneId(SiteRequestEnUS siteRequest_, String o) {
		return PixelArtGenPage.staticSearchStrDefaultZoneId(siteRequest_, PixelArtGenPage.staticSearchDefaultZoneId(siteRequest_, PixelArtGenPage.staticSetDefaultZoneId(siteRequest_, o)));
	}
	 ...
	 *  is defined as null before being initialized. 
	 * <br><a href="http://localhost:8983/solr/computate/select?q=*:*&fq=partEstEntite_indexed_boolean:true&fq=classeNomCanonique_enUS_indexed_string:org.computate.site.enus.model.pixelart.PixelArtGenPage&fq=entiteVar_enUS_indexed_string:defaultTimeZone">Find the entity defaultTimeZone in Solr</a>
	 * <br>
	 * @param w is for wrapping a value to assign to this entity during initialization. 
	 **/
	...
	protected PixelArtGenPage defaultTimeZoneInit() {
	 ...
	 *  is defined as null before being initialized. 
	 * <br><a href="http://localhost:8983/solr/computate/select?q=*:*&fq=partEstEntite_indexed_boolean:true&fq=classeNomCanonique_enUS_indexed_string:org.computate.site.enus.model.pixelart.PixelArtGenPage&fq=entiteVar_enUS_indexed_string:defaultLocaleId">Find the entity defaultLocaleId in Solr</a>
	 * <br>
	 * @param w is for wrapping a value to assign to this entity during initialization. 
	 **/
	...
	public void setDefaultLocaleId(String o) {
		this.defaultLocaleId = PixelArtGenPage.staticSetDefaultLocaleId(siteRequest_, o);
	}
	public static String staticSetDefaultLocaleId(SiteRequestEnUS siteRequest_, String o) {
		return o;
	}
	protected PixelArtGenPage defaultLocaleIdInit() {
	...
	public static String staticSearchFqDefaultLocaleId(SiteRequestEnUS siteRequest_, String o) {
		return PixelArtGenPage.staticSearchStrDefaultLocaleId(siteRequest_, PixelArtGenPage.staticSearchDefaultLocaleId(siteRequest_, PixelArtGenPage.staticSetDefaultLocaleId(siteRequest_, o)));
	}
	 ...
	 *  is defined as null before being initialized. 
	 * <br><a href="http://localhost:8983/solr/computate/select?q=*:*&fq=partEstEntite_indexed_boolean:true&fq=classeNomCanonique_enUS_indexed_string:org.computate.site.enus.model.pixelart.PixelArtGenPage&fq=entiteVar_enUS_indexed_string:defaultLocale">Find the entity defaultLocale in Solr</a>
	 * <br>
	 * @param w is for wrapping a value to assign to this entity during initialization. 
	 **/
	...
	protected PixelArtGenPage defaultLocaleInit() {
	 ...
	 *  is defined as null before being initialized. 
	 * <br><a href="http://localhost:8983/solr/computate/select?q=*:*&fq=partEstEntite_indexed_boolean:true&fq=classeNomCanonique_enUS_indexed_string:org.computate.site.enus.model.pixelart.PixelArtGenPage&fq=entiteVar_enUS_indexed_string:defaultRangeGap">Find the entity defaultRangeGap in Solr</a>
	 * <br>
	 * @param w is for wrapping a value to assign to this entity during initialization. 
	 **/
	...
	public void setDefaultRangeGap(String o) {
		this.defaultRangeGap = PixelArtGenPage.staticSetDefaultRangeGap(siteRequest_, o);
	}
	public static String staticSetDefaultRangeGap(SiteRequestEnUS siteRequest_, String o) {
		return o;
	}
	protected PixelArtGenPage defaultRangeGapInit() {
	...
	public static String staticSearchFqDefaultRangeGap(SiteRequestEnUS siteRequest_, String o) {
		return PixelArtGenPage.staticSearchStrDefaultRangeGap(siteRequest_, PixelArtGenPage.staticSearchDefaultRangeGap(siteRequest_, PixelArtGenPage.staticSetDefaultRangeGap(siteRequest_, o)));
	}
	 ...
	 *  is defined as null before being initialized. 
	 * <br><a href="http://localhost:8983/solr/computate/select?q=*:*&fq=partEstEntite_indexed_boolean:true&fq=classeNomCanonique_enUS_indexed_string:org.computate.site.enus.model.pixelart.PixelArtGenPage&fq=entiteVar_enUS_indexed_string:defaultRangeEnd">Find the entity defaultRangeEnd in Solr</a>
	 * <br>
	 * @param w is for wrapping a value to assign to this entity during initialization. 
	 **/
	...
	public void setDefaultRangeEnd(String o) {
		this.defaultRangeEnd = PixelArtGenPage.staticSetDefaultRangeEnd(siteRequest_, o);
	}
	...
	protected PixelArtGenPage defaultRangeEndInit() {
	...
	public static String staticSearchFqDefaultRangeEnd(SiteRequestEnUS siteRequest_, String o) {
		return PixelArtGenPage.staticSearchStrDefaultRangeEnd(siteRequest_, PixelArtGenPage.staticSearchDefaultRangeEnd(siteRequest_, PixelArtGenPage.staticSetDefaultRangeEnd(siteRequest_, o)));
	}
	 ...
	 *  is defined as null before being initialized. 
	 * <br><a href="http://localhost:8983/solr/computate/select?q=*:*&fq=partEstEntite_indexed_boolean:true&fq=classeNomCanonique_enUS_indexed_string:org.computate.site.enus.model.pixelart.PixelArtGenPage&fq=entiteVar_enUS_indexed_string:defaultRangeStart">Find the entity defaultRangeStart in Solr</a>
	 * <br>
	 * @param w is for wrapping a value to assign to this entity during initialization. 
	 **/
	...
	public void setDefaultRangeStart(String o) {
		this.defaultRangeStart = PixelArtGenPage.staticSetDefaultRangeStart(siteRequest_, o);
	}
	...
	protected PixelArtGenPage defaultRangeStartInit() {
	...
	public static String staticSearchFqDefaultRangeStart(SiteRequestEnUS siteRequest_, String o) {
		return PixelArtGenPage.staticSearchStrDefaultRangeStart(siteRequest_, PixelArtGenPage.staticSearchDefaultRangeStart(siteRequest_, PixelArtGenPage.staticSetDefaultRangeStart(siteRequest_, o)));
	}
	 ...
	 *  is defined as null before being initialized. 
	 * <br><a href="http://localhost:8983/solr/computate/select?q=*:*&fq=partEstEntite_indexed_boolean:true&fq=classeNomCanonique_enUS_indexed_string:org.computate.site.enus.model.pixelart.PixelArtGenPage&fq=entiteVar_enUS_indexed_string:defaultRangeVar">Find the entity defaultRangeVar in Solr</a>
	 * <br>
	 * @param w is for wrapping a value to assign to this entity during initialization. 
	 **/
	...
	public void setDefaultRangeVar(String o) {
		this.defaultRangeVar = PixelArtGenPage.staticSetDefaultRangeVar(siteRequest_, o);
	}
	public static String staticSetDefaultRangeVar(SiteRequestEnUS siteRequest_, String o) {
		return o;
	}
	protected PixelArtGenPage defaultRangeVarInit() {
	...
	public static String staticSearchFqDefaultRangeVar(SiteRequestEnUS siteRequest_, String o) {
		return PixelArtGenPage.staticSearchStrDefaultRangeVar(siteRequest_, PixelArtGenPage.staticSearchDefaultRangeVar(siteRequest_, PixelArtGenPage.staticSetDefaultRangeVar(siteRequest_, o)));
	}
	 ...
	 *  is defined as null before being initialized. 
	 * <br><a href="http://localhost:8983/solr/computate/select?q=*:*&fq=partEstEntite_indexed_boolean:true&fq=classeNomCanonique_enUS_indexed_string:org.computate.site.enus.model.pixelart.PixelArtGenPage&fq=entiteVar_enUS_indexed_string:defaultFacetSort">Find the entity defaultFacetSort in Solr</a>
	 * <br>
	 * @param w is for wrapping a value to assign to this entity during initialization. 
	 **/
	...
	public void setDefaultFacetSort(String o) {
		this.defaultFacetSort = PixelArtGenPage.staticSetDefaultFacetSort(siteRequest_, o);
	}
	public static String staticSetDefaultFacetSort(SiteRequestEnUS siteRequest_, String o) {
		return o;
	}
	protected PixelArtGenPage defaultFacetSortInit() {
	...
	public static String staticSearchFqDefaultFacetSort(SiteRequestEnUS siteRequest_, String o) {
		return PixelArtGenPage.staticSearchStrDefaultFacetSort(siteRequest_, PixelArtGenPage.staticSearchDefaultFacetSort(siteRequest_, PixelArtGenPage.staticSetDefaultFacetSort(siteRequest_, o)));
	}
	 ...
	 *  is defined as null before being initialized. 
	 * <br><a href="http://localhost:8983/solr/computate/select?q=*:*&fq=partEstEntite_indexed_boolean:true&fq=classeNomCanonique_enUS_indexed_string:org.computate.site.enus.model.pixelart.PixelArtGenPage&fq=entiteVar_enUS_indexed_string:defaultFacetLimit">Find the entity defaultFacetLimit in Solr</a>
	 * <br>
	 * @param w is for wrapping a value to assign to this entity during initialization. 
	 **/
	...
	public void setDefaultFacetLimit(String o) {
		this.defaultFacetLimit = PixelArtGenPage.staticSetDefaultFacetLimit(siteRequest_, o);
	}
	...
	protected PixelArtGenPage defaultFacetLimitInit() {
	...
	public static String staticSearchFqDefaultFacetLimit(SiteRequestEnUS siteRequest_, String o) {
		return PixelArtGenPage.staticSearchStrDefaultFacetLimit(siteRequest_, PixelArtGenPage.staticSearchDefaultFacetLimit(siteRequest_, PixelArtGenPage.staticSetDefaultFacetLimit(siteRequest_, o)));
	}
	 ...
	 *  is defined as null before being initialized. 
	 * <br><a href="http://localhost:8983/solr/computate/select?q=*:*&fq=partEstEntite_indexed_boolean:true&fq=classeNomCanonique_enUS_indexed_string:org.computate.site.enus.model.pixelart.PixelArtGenPage&fq=entiteVar_enUS_indexed_string:defaultFacetMinCount">Find the entity defaultFacetMinCount in Solr</a>
	 * <br>
	 * @param w is for wrapping a value to assign to this entity during initialization. 
	 **/
	...
	public void setDefaultFacetMinCount(String o) {
		this.defaultFacetMinCount = PixelArtGenPage.staticSetDefaultFacetMinCount(siteRequest_, o);
	}
	...
	protected PixelArtGenPage defaultFacetMinCountInit() {
	...
	public static String staticSearchFqDefaultFacetMinCount(SiteRequestEnUS siteRequest_, String o) {
		return PixelArtGenPage.staticSearchStrDefaultFacetMinCount(siteRequest_, PixelArtGenPage.staticSearchDefaultFacetMinCount(siteRequest_, PixelArtGenPage.staticSetDefaultFacetMinCount(siteRequest_, o)));
	}
	 ...
	 *  is defined as null before being initialized. 
	 * <br><a href="http://localhost:8983/solr/computate/select?q=*:*&fq=partEstEntite_indexed_boolean:true&fq=classeNomCanonique_enUS_indexed_string:org.computate.site.enus.model.pixelart.PixelArtGenPage&fq=entiteVar_enUS_indexed_string:defaultPivotMinCount">Find the entity defaultPivotMinCount in Solr</a>
	 * <br>
	 * @param w is for wrapping a value to assign to this entity during initialization. 
	 **/
	...
	public void setDefaultPivotMinCount(String o) {
		this.defaultPivotMinCount = PixelArtGenPage.staticSetDefaultPivotMinCount(siteRequest_, o);
	}
	...
	protected PixelArtGenPage defaultPivotMinCountInit() {
	...
	public static String staticSearchFqDefaultPivotMinCount(SiteRequestEnUS siteRequest_, String o) {
		return PixelArtGenPage.staticSearchStrDefaultPivotMinCount(siteRequest_, PixelArtGenPage.staticSearchDefaultPivotMinCount(siteRequest_, PixelArtGenPage.staticSetDefaultPivotMinCount(siteRequest_, o)));
	}
	 ...
	 *  is defined as null before being initialized. 
	 * <br><a href="http://localhost:8983/solr/computate/select?q=*:*&fq=partEstEntite_indexed_boolean:true&fq=classeNomCanonique_enUS_indexed_string:org.computate.site.enus.model.pixelart.PixelArtGenPage&fq=entiteVar_enUS_indexed_string:DEFAULT_MAP_LOCATION">Find the entity DEFAULT_MAP_LOCATION in Solr</a>
	 * <br>
	 * @param w is for wrapping a value to assign to this entity during initialization. 
	 **/
	...
	public void setDEFAULT_MAP_LOCATION(String o) {
		this.DEFAULT_MAP_LOCATION = PixelArtGenPage.staticSetDEFAULT_MAP_LOCATION(siteRequest_, o);
	}
	...
	protected PixelArtGenPage DEFAULT_MAP_LOCATIONInit() {
	...
	public static String staticSearchFqDEFAULT_MAP_LOCATION(SiteRequestEnUS siteRequest_, String o) {
		return PixelArtGenPage.staticSearchStrDEFAULT_MAP_LOCATION(siteRequest_, PixelArtGenPage.staticSearchDEFAULT_MAP_LOCATION(siteRequest_, PixelArtGenPage.staticSetDEFAULT_MAP_LOCATION(siteRequest_, o)));
	}
	 ...
	 *  is defined as null before being initialized. 
	 * <br><a href="http://localhost:8983/solr/computate/select?q=*:*&fq=partEstEntite_indexed_boolean:true&fq=classeNomCanonique_enUS_indexed_string:org.computate.site.enus.model.pixelart.PixelArtGenPage&fq=entiteVar_enUS_indexed_string:DEFAULT_MAP_ZOOM">Find the entity DEFAULT_MAP_ZOOM in Solr</a>
	 * <br>
	 * @param w is for wrapping a value to assign to this entity during initialization. 
	 **/
	...
	public void setDEFAULT_MAP_ZOOM(String o) {
		this.DEFAULT_MAP_ZOOM = PixelArtGenPage.staticSetDEFAULT_MAP_ZOOM(siteRequest_, o);
	}
	...
	protected PixelArtGenPage DEFAULT_MAP_ZOOMInit() {
	...
	public static String staticSearchFqDEFAULT_MAP_ZOOM(SiteRequestEnUS siteRequest_, String o) {
		return PixelArtGenPage.staticSearchStrDEFAULT_MAP_ZOOM(siteRequest_, PixelArtGenPage.staticSearchDEFAULT_MAP_ZOOM(siteRequest_, PixelArtGenPage.staticSetDEFAULT_MAP_ZOOM(siteRequest_, o)));
	}
	...
	/**	<br> The entity stats
	 *  is defined as null before being initialized. 
	 * <br><a href="http://localhost:8983/solr/computate/select?q=*:*&fq=partEstEntite_indexed_boolean:true&fq=classeNomCanonique_enUS_indexed_string:org.computate.site.enus.model.pixelart.PixelArtGenPage&fq=entiteVar_enUS_indexed_string:stats">Find the entity stats in Solr</a>
	 * <br>
	 * @param w is for wrapping a value to assign to this entity during initialization. 
	 **/
	...
	protected PixelArtGenPage statsInit() {
	 ...
	 *  is defined as null before being initialized. 
	 * <br><a href="http://localhost:8983/solr/computate/select?q=*:*&fq=partEstEntite_indexed_boolean:true&fq=classeNomCanonique_enUS_indexed_string:org.computate.site.enus.model.pixelart.PixelArtGenPage&fq=entiteVar_enUS_indexed_string:facetCounts">Find the entity facetCounts in Solr</a>
	 * <br>
	 * @param w is for wrapping a value to assign to this entity during initialization. 
	 **/
	...
	protected PixelArtGenPage facetCountsInit() {
	...
	public Object obtainPixelArtGenPage(String var) {
		...
		switch(var) {
			...
			case "pageResponse":
				return oPixelArtGenPage.pageResponse;
			case "defaultZoneId":
				return oPixelArtGenPage.defaultZoneId;
			case "defaultTimeZone":
				return oPixelArtGenPage.defaultTimeZone;
			case "defaultLocaleId":
				return oPixelArtGenPage.defaultLocaleId;
			case "defaultLocale":
				return oPixelArtGenPage.defaultLocale;
			case "defaultRangeGap":
				return oPixelArtGenPage.defaultRangeGap;
			case "defaultRangeEnd":
				return oPixelArtGenPage.defaultRangeEnd;
			case "defaultRangeStart":
				return oPixelArtGenPage.defaultRangeStart;
			case "defaultRangeVar":
				return oPixelArtGenPage.defaultRangeVar;
			case "defaultFacetSort":
				return oPixelArtGenPage.defaultFacetSort;
			case "defaultFacetLimit":
				return oPixelArtGenPage.defaultFacetLimit;
			case "defaultFacetMinCount":
				return oPixelArtGenPage.defaultFacetMinCount;
			case "defaultPivotMinCount":
				return oPixelArtGenPage.defaultPivotMinCount;
			case "DEFAULT_MAP_LOCATION":
				return oPixelArtGenPage.DEFAULT_MAP_LOCATION;
			case "DEFAULT_MAP_ZOOM":
				return oPixelArtGenPage.DEFAULT_MAP_ZOOM;
			case "listPixelArt":
				return oPixelArtGenPage.listPixelArt;
			case "stats":
				return oPixelArtGenPage.stats;
			case "facetCounts":
				return oPixelArtGenPage.facetCounts;
			case "pixelArtCount":
	...
	public static Object staticSetPixelArtGenPage(String entityVar, SiteRequestEnUS siteRequest_, String o) {
		switch(entityVar) {
		case "pageResponse":
			return PixelArtGenPage.staticSetPageResponse(siteRequest_, o);
		case "defaultZoneId":
			return PixelArtGenPage.staticSetDefaultZoneId(siteRequest_, o);
		case "defaultLocaleId":
			return PixelArtGenPage.staticSetDefaultLocaleId(siteRequest_, o);
		case "defaultRangeGap":
			return PixelArtGenPage.staticSetDefaultRangeGap(siteRequest_, o);
		case "defaultRangeEnd":
			return PixelArtGenPage.staticSetDefaultRangeEnd(siteRequest_, o);
		case "defaultRangeStart":
			return PixelArtGenPage.staticSetDefaultRangeStart(siteRequest_, o);
		case "defaultRangeVar":
			return PixelArtGenPage.staticSetDefaultRangeVar(siteRequest_, o);
		case "defaultFacetSort":
			return PixelArtGenPage.staticSetDefaultFacetSort(siteRequest_, o);
		case "defaultFacetLimit":
			return PixelArtGenPage.staticSetDefaultFacetLimit(siteRequest_, o);
		case "defaultFacetMinCount":
			return PixelArtGenPage.staticSetDefaultFacetMinCount(siteRequest_, o);
		case "defaultPivotMinCount":
			return PixelArtGenPage.staticSetDefaultPivotMinCount(siteRequest_, o);
		case "DEFAULT_MAP_LOCATION":
			return PixelArtGenPage.staticSetDEFAULT_MAP_LOCATION(siteRequest_, o);
		case "DEFAULT_MAP_ZOOM":
			return PixelArtGenPage.staticSetDEFAULT_MAP_ZOOM(siteRequest_, o);
		case "pixelArtCount":
	...
	public static Object staticSearchPixelArtGenPage(String entityVar, SiteRequestEnUS siteRequest_, Object o) {
		switch(entityVar) {
		case "pageResponse":
			return PixelArtGenPage.staticSearchPageResponse(siteRequest_, (String)o);
		case "defaultZoneId":
			return PixelArtGenPage.staticSearchDefaultZoneId(siteRequest_, (String)o);
		case "defaultLocaleId":
			return PixelArtGenPage.staticSearchDefaultLocaleId(siteRequest_, (String)o);
		case "defaultRangeGap":
			return PixelArtGenPage.staticSearchDefaultRangeGap(siteRequest_, (String)o);
		case "defaultRangeEnd":
			return PixelArtGenPage.staticSearchDefaultRangeEnd(siteRequest_, (ZonedDateTime)o);
		case "defaultRangeStart":
			return PixelArtGenPage.staticSearchDefaultRangeStart(siteRequest_, (ZonedDateTime)o);
		case "defaultRangeVar":
			return PixelArtGenPage.staticSearchDefaultRangeVar(siteRequest_, (String)o);
		case "defaultFacetSort":
			return PixelArtGenPage.staticSearchDefaultFacetSort(siteRequest_, (String)o);
		case "defaultFacetLimit":
			return PixelArtGenPage.staticSearchDefaultFacetLimit(siteRequest_, (Integer)o);
		case "defaultFacetMinCount":
			return PixelArtGenPage.staticSearchDefaultFacetMinCount(siteRequest_, (Integer)o);
		case "defaultPivotMinCount":
			return PixelArtGenPage.staticSearchDefaultPivotMinCount(siteRequest_, (Integer)o);
		case "DEFAULT_MAP_LOCATION":
			return PixelArtGenPage.staticSearchDEFAULT_MAP_LOCATION(siteRequest_, (JsonObject)o);
		case "DEFAULT_MAP_ZOOM":
			return PixelArtGenPage.staticSearchDEFAULT_MAP_ZOOM(siteRequest_, (BigDecimal)o);
		case "pixelArtCount":
	...
	public static String staticSearchStrPixelArtGenPage(String entityVar, SiteRequestEnUS siteRequest_, Object o) {
		switch(entityVar) {
		case "pageResponse":
			return PixelArtGenPage.staticSearchStrPageResponse(siteRequest_, (String)o);
		case "defaultZoneId":
			return PixelArtGenPage.staticSearchStrDefaultZoneId(siteRequest_, (String)o);
		case "defaultLocaleId":
			return PixelArtGenPage.staticSearchStrDefaultLocaleId(siteRequest_, (String)o);
		case "defaultRangeGap":
			return PixelArtGenPage.staticSearchStrDefaultRangeGap(siteRequest_, (String)o);
		case "defaultRangeEnd":
			return PixelArtGenPage.staticSearchStrDefaultRangeEnd(siteRequest_, (Date)o);
		case "defaultRangeStart":
			return PixelArtGenPage.staticSearchStrDefaultRangeStart(siteRequest_, (Date)o);
		case "defaultRangeVar":
			return PixelArtGenPage.staticSearchStrDefaultRangeVar(siteRequest_, (String)o);
		case "defaultFacetSort":
			return PixelArtGenPage.staticSearchStrDefaultFacetSort(siteRequest_, (String)o);
		case "defaultFacetLimit":
			return PixelArtGenPage.staticSearchStrDefaultFacetLimit(siteRequest_, (Integer)o);
		case "defaultFacetMinCount":
			return PixelArtGenPage.staticSearchStrDefaultFacetMinCount(siteRequest_, (Integer)o);
		case "defaultPivotMinCount":
			return PixelArtGenPage.staticSearchStrDefaultPivotMinCount(siteRequest_, (Integer)o);
		case "DEFAULT_MAP_LOCATION":
			return PixelArtGenPage.staticSearchStrDEFAULT_MAP_LOCATION(siteRequest_, (JsonObject)o);
		case "DEFAULT_MAP_ZOOM":
			return PixelArtGenPage.staticSearchStrDEFAULT_MAP_ZOOM(siteRequest_, (Double)o);
		case "pixelArtCount":
	...
	public static String staticSearchFqPixelArtGenPage(String entityVar, SiteRequestEnUS siteRequest_, String o) {
		switch(entityVar) {
		case "pageResponse":
			return PixelArtGenPage.staticSearchFqPageResponse(siteRequest_, o);
		case "defaultZoneId":
			return PixelArtGenPage.staticSearchFqDefaultZoneId(siteRequest_, o);
		case "defaultLocaleId":
			return PixelArtGenPage.staticSearchFqDefaultLocaleId(siteRequest_, o);
		case "defaultRangeGap":
			return PixelArtGenPage.staticSearchFqDefaultRangeGap(siteRequest_, o);
		case "defaultRangeEnd":
			return PixelArtGenPage.staticSearchFqDefaultRangeEnd(siteRequest_, o);
		case "defaultRangeStart":
			return PixelArtGenPage.staticSearchFqDefaultRangeStart(siteRequest_, o);
		case "defaultRangeVar":
			return PixelArtGenPage.staticSearchFqDefaultRangeVar(siteRequest_, o);
		case "defaultFacetSort":
			return PixelArtGenPage.staticSearchFqDefaultFacetSort(siteRequest_, o);
		case "defaultFacetLimit":
			return PixelArtGenPage.staticSearchFqDefaultFacetLimit(siteRequest_, o);
		case "defaultFacetMinCount":
			return PixelArtGenPage.staticSearchFqDefaultFacetMinCount(siteRequest_, o);
		case "defaultPivotMinCount":
			return PixelArtGenPage.staticSearchFqDefaultPivotMinCount(siteRequest_, o);
		case "DEFAULT_MAP_LOCATION":
			return PixelArtGenPage.staticSearchFqDEFAULT_MAP_LOCATION(siteRequest_, o);
		case "DEFAULT_MAP_ZOOM":
			return PixelArtGenPage.staticSearchFqDEFAULT_MAP_ZOOM(siteRequest_, o);
		case "pixelArtCount":
