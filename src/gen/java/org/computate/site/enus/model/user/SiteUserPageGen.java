...
import org.computate.site.enus.model.user.SiteUserGenPage;
...
/**	
<ol>
0<li>You can add a class comment "{@inheritDoc}" if you wish to inherit the helpful inherited class comments from class SiteUserPageGen into the class SiteUserPage. 
</li>
0<li>You can add a class comment <b>"Api: true"</b> if you wish to GET, POST, PATCH or PUT these SiteUserPage objects in a RESTful API. 
</li>
...
<p><a href="http://localhost:8983/solr/computate/select?q=*:*&fq=partEstClasse_indexed_boolean:true&fq=classeNomCanonique__indexed_string:org.computate.site.enus.model.user.SiteUserPage">Find the class SiteUserPage in Solr. </a></p>
<p>
...
0<h1>Suggestions that can generate more code for you: </h1>0<h1>About the SiteUserPage class and it's generated class SiteUserPageGen&lt;SiteUserGenPage&gt;: </h1><p>
...
curl 'http://localhost:8983/solr/computate/update?commitWithin=1000&overwrite=true&wt=json' -X POST -H 'Content-type: text/xml' --data-raw '&lt;add&gt;&lt;delete&gt;&lt;query&gt;classeNomCanonique__indexed_string:org.computate.site.enus.model.user.SiteUserPage&lt;/query&gt;&lt;/delete&gt;&lt;/add&gt;'
</p>
<p>
