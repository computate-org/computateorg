package org.computate.site.enUS.chaine;
...
import org.computate.site.enUS.page.parti.Icone;
...
/**	
 * <br/><a href="http://localhost:10383/solr/computate/select?q=*:*&fq=partEstClasse_indexed_boolean:true&fq=classeNomCanonique_enUS_indexed_string:org.computate.site.enUS.chaine.Chaine&fq=classeEtendGen_indexed_boolean:true">Trouver la classe  dans Solr</a>
 * <br/>
 **/
public abstract class ChaineGen<DEV> extends Object {
	 ...
	 * <br/><a href="http://localhost:10383/solr/computate/select?q=*:*&fq=partEstEntite_indexed_boolean:true&fq=classeNomCanonique_enUS_indexed_string:org.computate.site.enUS.chaine.Chaine&fq=classeEtendGen_indexed_boolean:true&fq=entiteVar_enUS_indexed_string:requeteSite_">Trouver l'entité requeteSite_ dans Solr</a>
	 * <br/>
	...
	/**	<br/>L'entité « police »
	 *  est défini comme null avant d'être initialisé. 
	 * <br/><a href="http://localhost:10383/solr/computate/select?q=*:*&fq=partEstEntite_indexed_boolean:true&fq=classeNomCanonique_enUS_indexed_string:org.computate.site.enUS.chaine.Chaine&fq=classeEtendGen_indexed_boolean:true&fq=entiteVar_enUS_indexed_string:police">Trouver l'entité police dans Solr</a>
	 * <br/>
	 * @param c est pour envelopper une valeur à assigner à cette entité lors de l'initialisation. 
	 **/
	 ...
	 *  est défini comme null avant d'être initialisé. 
	 * <br/><a href="http://localhost:10383/solr/computate/select?q=*:*&fq=partEstEntite_indexed_boolean:true&fq=classeNomCanonique_enUS_indexed_string:org.computate.site.enUS.chaine.Chaine&fq=classeEtendGen_indexed_boolean:true&fq=entiteVar_enUS_indexed_string:alignerCentre">Trouver l'entité alignerCentre dans Solr</a>
	 * <br/>
	 * @param c est pour envelopper une valeur à assigner à cette entité lors de l'initialisation. 
	 **/
	 ...
	 *  est défini comme null avant d'être initialisé. 
	 * <br/><a href="http://localhost:10383/solr/computate/select?q=*:*&fq=partEstEntite_indexed_boolean:true&fq=classeNomCanonique_enUS_indexed_string:org.computate.site.enUS.chaine.Chaine&fq=classeEtendGen_indexed_boolean:true&fq=entiteVar_enUS_indexed_string:alignerGauche">Trouver l'entité alignerGauche dans Solr</a>
	 * <br/>
	 * @param c est pour envelopper une valeur à assigner à cette entité lors de l'initialisation. 
	 **/
	 ...
	 *  est défini comme null avant d'être initialisé. 
	 * <br/><a href="http://localhost:10383/solr/computate/select?q=*:*&fq=partEstEntite_indexed_boolean:true&fq=classeNomCanonique_enUS_indexed_string:org.computate.site.enUS.chaine.Chaine&fq=classeEtendGen_indexed_boolean:true&fq=entiteVar_enUS_indexed_string:alignerDroit">Trouver l'entité alignerDroit dans Solr</a>
	 * <br/>
	 * @param c est pour envelopper une valeur à assigner à cette entité lors de l'initialisation. 
	 **/
	 ...
	 * Il est construit avant d'être initialisé avec le constructeur par défaut ArrayList<Icone>(). 
	 * <br/><a href="http://localhost:10383/solr/computate/select?q=*:*&fq=partEstEntite_indexed_boolean:true&fq=classeNomCanonique_enUS_indexed_string:org.computate.site.enUS.chaine.Chaine&fq=classeEtendGen_indexed_boolean:true&fq=entiteVar_enUS_indexed_string:iconesAvant">Trouver l'entité iconesAvant dans Solr</a>
	 * <br/>
	 ...
	 * Il est construit avant d'être initialisé avec le constructeur par défaut ArrayList<Icone>(). 
	 * <br/><a href="http://localhost:10383/solr/computate/select?q=*:*&fq=partEstEntite_indexed_boolean:true&fq=classeNomCanonique_enUS_indexed_string:org.computate.site.enUS.chaine.Chaine&fq=classeEtendGen_indexed_boolean:true&fq=entiteVar_enUS_indexed_string:iconesApres">Trouver l'entité iconesApres dans Solr</a>
	 * <br/>
	 ...
	 *  est défini comme null avant d'être initialisé. 
	 * <br/><a href="http://localhost:10383/solr/computate/select?q=*:*&fq=partEstEntite_indexed_boolean:true&fq=classeNomCanonique_enUS_indexed_string:org.computate.site.enUS.chaine.Chaine&fq=classeEtendGen_indexed_boolean:true&fq=entiteVar_enUS_indexed_string:xDecalage">Trouver l'entité xDecalage dans Solr</a>
	 * <br/>
	 * @param c est pour envelopper une valeur à assigner à cette entité lors de l'initialisation. 
	 **/
	 ...
	 *  est défini comme null avant d'être initialisé. 
	 * <br/><a href="http://localhost:10383/solr/computate/select?q=*:*&fq=partEstEntite_indexed_boolean:true&fq=classeNomCanonique_enUS_indexed_string:org.computate.site.enUS.chaine.Chaine&fq=classeEtendGen_indexed_boolean:true&fq=entiteVar_enUS_indexed_string:yDecalage">Trouver l'entité yDecalage dans Solr</a>
	 * <br/>
	 * @param c est pour envelopper une valeur à assigner à cette entité lors de l'initialisation. 
	 **/
	...
	/**	<br/>L'entité « hLigne »
	 *  est défini comme null avant d'être initialisé. 
	 * <br/><a href="http://localhost:10383/solr/computate/select?q=*:*&fq=partEstEntite_indexed_boolean:true&fq=classeNomCanonique_enUS_indexed_string:org.computate.site.enUS.chaine.Chaine&fq=classeEtendGen_indexed_boolean:true&fq=entiteVar_enUS_indexed_string:hLigne">Trouver l'entité hLigne dans Solr</a>
	 * <br/>
	 * @param c est pour envelopper une valeur à assigner à cette entité lors de l'initialisation. 
	 **/
	...
	/**	<br/>L'entité « hEspace »
	 *  est défini comme null avant d'être initialisé. 
	 * <br/><a href="http://localhost:10383/solr/computate/select?q=*:*&fq=partEstEntite_indexed_boolean:true&fq=classeNomCanonique_enUS_indexed_string:org.computate.site.enUS.chaine.Chaine&fq=classeEtendGen_indexed_boolean:true&fq=entiteVar_enUS_indexed_string:hEspace">Trouver l'entité hEspace dans Solr</a>
	 * <br/>
	 * @param c est pour envelopper une valeur à assigner à cette entité lors de l'initialisation. 
	 **/
	...
	/**	<br/>L'entité « tout »
	 * Il est construit avant d'être initialisé avec le constructeur par défaut ArrayList<Object>(). 
	 * <br/><a href="http://localhost:10383/solr/computate/select?q=*:*&fq=partEstEntite_indexed_boolean:true&fq=classeNomCanonique_enUS_indexed_string:org.computate.site.enUS.chaine.Chaine&fq=classeEtendGen_indexed_boolean:true&fq=entiteVar_enUS_indexed_string:tout">Trouver l'entité tout dans Solr</a>
	 * <br/>
