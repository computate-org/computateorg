...
/**
 * Translate: false
 * CanonicalName.frFR: org.computate.site.enus.course.c001.lesson.C001LessonFrFRGenApiServiceImpl
 **/
public class C001LessonEnUSGenApiServiceImpl extends BaseApiServiceImpl implements C001LessonEnUSGenApiService {
		...
		try {
			...
			if(facetPivot != null) {
				...
				for(SolrResponse.Pivot pivot : facetPivot.getPivotMap().values()) {
					...
					responsePivotSearchPageC001Lesson(pivot.getPivotList(), pivotArray);
				}
			}
	...
	public Future<Void> persistC001Lesson(C001Lesson o) {
