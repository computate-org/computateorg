 ...
 * 
 * Title.frFR: Quel est l'étape première pour créer mon propre site Web ? Choisir un nom de domaine. 
 * Title.enUS: What is the first step to creating my own website? Choose a domain name. 
 * 
...
*/
public class C001L001ChooseDomainName extends C001L001ChooseDomainNameGen<C001Lesson> {
...
//		c.o(C001L001ChooseDomainName_H1_frFR);
	...
	@Override protected void _articleH1_enUS(Wrap<String> c) {
		c.o(C001L001ChooseDomainName_H1_enUS);
	}
...
//		c.o(C001L001ChooseDomainName_H2_frFR);
	...
	@Override protected void _articleH2_enUS(Wrap<String> c) {
		c.o(C001L001ChooseDomainName_H2_enUS);
	}
...
//		c.o(SearchPage_frFR_ImageUri);
	...
	@Override protected void _pageSearch_enUS(List<String> l) {
		addPageSearch_enUS(C001L001ChooseDomainName_H1_enUS);
		addPageSearch_enUS(C001L001ChooseDomainName_H2_enUS);
		addPageSearch_enUS(C001L001ChooseDomainNameVals);
	}
...
//		addPageSearch_frFR(C001L001ChooseDomainName_H2_frFR);
	...
	/**
	 * {@inheritDoc}
	 * Val.P.frFR:Envisagez-vous de créer un site Web à vous ? 
	 * Val.P.frFR:Peut-être vous demandez-vous quelle est la première étape de la création de votre site Web ? 
...
//	protected void _plusTard(QuestionReponse o) {      
	 ...
	 * Langue: frFR
	 **/
	protected void _lessonSearch_frFR(List<String> l) {
