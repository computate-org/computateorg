...
import org.computate.site.enUS.cours.c001.l005.C001L005InstallerMavenEnUSPage;


/**
 * Traduire: false
 **/
public class C001L005InstallerMavenEnUSGenApiServiceImpl implements C001L005InstallerMavenEnUSGenApiService {

	protected static final Logger LOGGER = LoggerFactory.getLogger(C001L005InstallerMavenEnUSGenApiServiceImpl.class);

	protected static final String SERVICE_ADDRESS = "C001L005InstallerMavenEnUSApiServiceImpl";

	protected SiteContexteEnUS siteContexte;

	public C001L005InstallerMavenEnUSGenApiServiceImpl(SiteContexteEnUS siteContexte) {
		this.siteContexte = siteContexte;
		C001L005InstallerMavenEnUSGenApiService service = C001L005InstallerMavenEnUSGenApiService.creerProxy(siteContexte.getVertx(), SERVICE_ADDRESS);
	}
	...
	public void rechercheenuspageC001L005InstallerMavenId(OperationRequest operationRequete, Handler<AsyncResult<OperationResponse>> gestionnaireEvenements) {
		rechercheenuspageC001L005InstallerMaven(operationRequete, gestionnaireEvenements);
	}
	...
	public void rechercheenuspageC001L005InstallerMaven(OperationRequest operationRequete, Handler<AsyncResult<OperationResponse>> gestionnaireEvenements) {
		try {
			RequeteSiteEnUS requeteSite = genererRequeteSiteEnUSPourC001L005InstallerMaven(siteContexte, operationRequete);
			sqlC001L005InstallerMaven(requeteSite, a -> {
				if(a.succeeded()) {
					utilisateurC001L005InstallerMaven(requeteSite, b -> {
						if(b.succeeded()) {
							rechercheC001L005InstallerMaven(requeteSite, false, true, "/enUS/course/001/004-how-to-install-the-latest-version-of-maven", c -> {
								if(c.succeeded()) {
									ListeRecherche<C001L005InstallerMaven> listeC001L005InstallerMaven = c.result();
									reponse200RechercheEnUSPageC001L005InstallerMaven(listeC001L005InstallerMaven, d -> {
										if(d.succeeded()) {
	...
	public void reponse200RechercheEnUSPageC001L005InstallerMaven(ListeRecherche<C001L005InstallerMaven> listeC001L005InstallerMaven, Handler<AsyncResult<OperationResponse>> gestionnaireEvenements) {
		try {
			Buffer buffer = Buffer.buffer();
			RequeteSiteEnUS requeteSite = listeC001L005InstallerMaven.getRequeteSite_();
			ToutEcrivain w = ToutEcrivain.creer(listeC001L005InstallerMaven.getRequeteSite_(), buffer);
			requeteSite.setW(w);
			C001L005InstallerMavenEnUSPage page = new C001L005InstallerMavenEnUSPage();
			SolrDocument pageDocumentSolr = new SolrDocument();

			pageDocumentSolr.setField("pageUri_frFR_stored_string", "/enUS/course/001/004-how-to-install-the-latest-version-of-maven");
			page.setPageDocumentSolr(pageDocumentSolr);
			page.setW(w);
			page.initLoinC001L005InstallerMavenEnUSPage(requeteSite);
			page.html();
	...
	public void erreurC001L005InstallerMaven(RequeteSiteEnUS requeteSite, Handler<AsyncResult<OperationResponse>> gestionnaireEvenements, AsyncResult<?> resultatAsync) {
	...
	public void sqlC001L005InstallerMaven(RequeteSiteEnUS requeteSite, Handler<AsyncResult<OperationResponse>> gestionnaireEvenements) {
		try {
	...
	public RequeteSiteEnUS genererRequeteSiteEnUSPourC001L005InstallerMaven(SiteContexteEnUS siteContexte, OperationRequest operationRequete) {
		return genererRequeteSiteEnUSPourC001L005InstallerMaven(siteContexte, operationRequete, null);
	}

	public RequeteSiteEnUS genererRequeteSiteEnUSPourC001L005InstallerMaven(SiteContexteEnUS siteContexte, OperationRequest operationRequete, JsonObject body) {
	...
	public void utilisateurC001L005InstallerMaven(RequeteSiteEnUS requeteSite, Handler<AsyncResult<OperationResponse>> gestionnaireEvenements) {
		try {
			SQLConnection connexionSql = requeteSite.getConnexionSql();
	...
	public void rechercheC001L005InstallerMaven(RequeteSiteEnUS requeteSite, Boolean peupler, Boolean stocker, String classeApiUriMethode, Handler<AsyncResult<ListeRecherche<C001L005InstallerMaven>>> gestionnaireEvenements) {
		try {
			...
			listeRecherche.addFilterQuery("classeNomsCanoniques_indexed_strings:" + ClientUtils.escapeQueryChars("org.computate.site.enUS.cours.c001.l005.C001L005InstallerMaven"));
