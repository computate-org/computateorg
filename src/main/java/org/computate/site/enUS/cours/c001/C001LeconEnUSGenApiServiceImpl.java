...
public class C001LeconEnUSGenApiServiceImpl implements C001LeconEnUSGenApiService {
	...
	protected static final Logger LOGGER = LoggerFactory.getLogger(C001LeconEnUSGenApiServiceImpl.class);

	protected static final String SERVICE_ADDRESS = "C001LeconEnUSApiServiceImpl";
	...
	public void rechercheC001Lecon(RequeteSiteEnUS requeteSite, Boolean peupler, Boolean stocker, String classeApiUriMethode, Handler<AsyncResult<ListeRecherche<C001Lecon>>> gestionnaireEvenements) {
		try {
			...
			listeRecherche.addFilterQuery("classeNomsCanoniques_indexed_strings:" + ClientUtils.escapeQueryChars("org.computate.site.enUS.cours.c001.C001Lecon"));
