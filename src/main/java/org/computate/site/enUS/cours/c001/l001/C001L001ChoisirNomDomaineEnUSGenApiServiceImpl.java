...
import org.computate.site.enUS.cours.c001.l001.C001L001ChoisirNomDomaineEnUSPage;


/**
 * Traduire: false
 **/
public class C001L001ChoisirNomDomaineEnUSGenApiServiceImpl implements C001L001ChoisirNomDomaineEnUSGenApiService {

	protected static final Logger LOGGER = LoggerFactory.getLogger(C001L001ChoisirNomDomaineEnUSGenApiServiceImpl.class);

	protected static final String SERVICE_ADDRESS = "C001L001ChoisirNomDomaineEnUSApiServiceImpl";

	protected SiteContexteEnUS siteContexte;

	public C001L001ChoisirNomDomaineEnUSGenApiServiceImpl(SiteContexteEnUS siteContexte) {
		this.siteContexte = siteContexte;
		C001L001ChoisirNomDomaineEnUSGenApiService service = C001L001ChoisirNomDomaineEnUSGenApiService.creerProxy(siteContexte.getVertx(), SERVICE_ADDRESS);
	}
	...
	public void rechercheenuspageC001L001ChoisirNomDomaineId(OperationRequest operationRequete, Handler<AsyncResult<OperationResponse>> gestionnaireEvenements) {
		rechercheenuspageC001L001ChoisirNomDomaine(operationRequete, gestionnaireEvenements);
	}
	...
	public void rechercheenuspageC001L001ChoisirNomDomaine(OperationRequest operationRequete, Handler<AsyncResult<OperationResponse>> gestionnaireEvenements) {
		try {
			RequeteSiteEnUS requeteSite = genererRequeteSiteEnUSPourC001L001ChoisirNomDomaine(siteContexte, operationRequete);
			sqlC001L001ChoisirNomDomaine(requeteSite, a -> {
				if(a.succeeded()) {
					utilisateurC001L001ChoisirNomDomaine(requeteSite, b -> {
						if(b.succeeded()) {
							rechercheC001L001ChoisirNomDomaine(requeteSite, false, true, "/enUS/course/001/001-choose-domain-name", c -> {
								if(c.succeeded()) {
	...
	public void reponse200RechercheEnUSPageC001L001ChoisirNomDomaine(ListeRecherche<C001L001ChoisirNomDomaine> listeC001L001ChoisirNomDomaine, Handler<AsyncResult<OperationResponse>> gestionnaireEvenements) {
		try {
			...
			RequeteSiteEnUS requeteSite = listeC001L001ChoisirNomDomaine.getRequeteSite_();
			...
			page.setW(w);
			page.initLoinC001L001ChoisirNomDomaineEnUSPage(requeteSite);
			page.html();
	...
	public void erreurC001L001ChoisirNomDomaine(RequeteSiteEnUS requeteSite, Handler<AsyncResult<OperationResponse>> gestionnaireEvenements, AsyncResult<?> resultatAsync) {
	...
	public void sqlC001L001ChoisirNomDomaine(RequeteSiteEnUS requeteSite, Handler<AsyncResult<OperationResponse>> gestionnaireEvenements) {
		try {
	...
	public RequeteSiteEnUS genererRequeteSiteEnUSPourC001L001ChoisirNomDomaine(SiteContexteEnUS siteContexte, OperationRequest operationRequete) {
		return genererRequeteSiteEnUSPourC001L001ChoisirNomDomaine(siteContexte, operationRequete, null);
	}

	public RequeteSiteEnUS genererRequeteSiteEnUSPourC001L001ChoisirNomDomaine(SiteContexteEnUS siteContexte, OperationRequest operationRequete, JsonObject body) {
	...
	public void utilisateurC001L001ChoisirNomDomaine(RequeteSiteEnUS requeteSite, Handler<AsyncResult<OperationResponse>> gestionnaireEvenements) {
		try {
			SQLConnection connexionSql = requeteSite.getConnexionSql();
	...
	public void rechercheC001L001ChoisirNomDomaine(RequeteSiteEnUS requeteSite, Boolean peupler, Boolean stocker, String classeApiUriMethode, Handler<AsyncResult<ListeRecherche<C001L001ChoisirNomDomaine>>> gestionnaireEvenements) {
		try {
			...
			listeRecherche.addFilterQuery("classeNomsCanoniques_indexed_strings:" + ClientUtils.escapeQueryChars("org.computate.site.enUS.cours.c001.l001.C001L001ChoisirNomDomaine"));
