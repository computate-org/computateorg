...
import org.computate.site.enUS.cours.c001.l006.C001L006InstallerEclipseEnUSPage;


/**
 * Traduire: false
 **/
public class C001L006InstallerEclipseEnUSGenApiServiceImpl implements C001L006InstallerEclipseEnUSGenApiService {

	protected static final Logger LOGGER = LoggerFactory.getLogger(C001L006InstallerEclipseEnUSGenApiServiceImpl.class);

	protected static final String SERVICE_ADDRESS = "C001L006InstallerEclipseEnUSApiServiceImpl";

	protected SiteContexteEnUS siteContexte;

	public C001L006InstallerEclipseEnUSGenApiServiceImpl(SiteContexteEnUS siteContexte) {
		this.siteContexte = siteContexte;
		C001L006InstallerEclipseEnUSGenApiService service = C001L006InstallerEclipseEnUSGenApiService.creerProxy(siteContexte.getVertx(), SERVICE_ADDRESS);
	}
	...
	public void rechercheenuspageC001L006InstallerEclipseId(OperationRequest operationRequete, Handler<AsyncResult<OperationResponse>> gestionnaireEvenements) {
		rechercheenuspageC001L006InstallerEclipse(operationRequete, gestionnaireEvenements);
	}
	...
	public void rechercheenuspageC001L006InstallerEclipse(OperationRequest operationRequete, Handler<AsyncResult<OperationResponse>> gestionnaireEvenements) {
		try {
			RequeteSiteEnUS requeteSite = genererRequeteSiteEnUSPourC001L006InstallerEclipse(siteContexte, operationRequete);
			sqlC001L006InstallerEclipse(requeteSite, a -> {
				if(a.succeeded()) {
					utilisateurC001L006InstallerEclipse(requeteSite, b -> {
						if(b.succeeded()) {
							rechercheC001L006InstallerEclipse(requeteSite, false, true, "/enUS/course/001/006-how-to-install-eclipse", c -> {
								if(c.succeeded()) {
									ListeRecherche<C001L006InstallerEclipse> listeC001L006InstallerEclipse = c.result();
									reponse200RechercheEnUSPageC001L006InstallerEclipse(listeC001L006InstallerEclipse, d -> {
										if(d.succeeded()) {
	...
	public void reponse200RechercheEnUSPageC001L006InstallerEclipse(ListeRecherche<C001L006InstallerEclipse> listeC001L006InstallerEclipse, Handler<AsyncResult<OperationResponse>> gestionnaireEvenements) {
		try {
			Buffer buffer = Buffer.buffer();
			RequeteSiteEnUS requeteSite = listeC001L006InstallerEclipse.getRequeteSite_();
			ToutEcrivain w = ToutEcrivain.creer(listeC001L006InstallerEclipse.getRequeteSite_(), buffer);
			requeteSite.setW(w);
			C001L006InstallerEclipseEnUSPage page = new C001L006InstallerEclipseEnUSPage();
			SolrDocument pageDocumentSolr = new SolrDocument();

			pageDocumentSolr.setField("pageUri_frFR_stored_string", "/enUS/course/001/006-how-to-install-eclipse");
			page.setPageDocumentSolr(pageDocumentSolr);
			page.setW(w);
			page.initLoinC001L006InstallerEclipseEnUSPage(requeteSite);
			page.html();
	...
	public void erreurC001L006InstallerEclipse(RequeteSiteEnUS requeteSite, Handler<AsyncResult<OperationResponse>> gestionnaireEvenements, AsyncResult<?> resultatAsync) {
	...
	public void sqlC001L006InstallerEclipse(RequeteSiteEnUS requeteSite, Handler<AsyncResult<OperationResponse>> gestionnaireEvenements) {
		try {
	...
	public RequeteSiteEnUS genererRequeteSiteEnUSPourC001L006InstallerEclipse(SiteContexteEnUS siteContexte, OperationRequest operationRequete) {
		return genererRequeteSiteEnUSPourC001L006InstallerEclipse(siteContexte, operationRequete, null);
	}

	public RequeteSiteEnUS genererRequeteSiteEnUSPourC001L006InstallerEclipse(SiteContexteEnUS siteContexte, OperationRequest operationRequete, JsonObject body) {
	...
	public void utilisateurC001L006InstallerEclipse(RequeteSiteEnUS requeteSite, Handler<AsyncResult<OperationResponse>> gestionnaireEvenements) {
		try {
			SQLConnection connexionSql = requeteSite.getConnexionSql();
	...
	public void rechercheC001L006InstallerEclipse(RequeteSiteEnUS requeteSite, Boolean peupler, Boolean stocker, String classeApiUriMethode, Handler<AsyncResult<ListeRecherche<C001L006InstallerEclipse>>> gestionnaireEvenements) {
		try {
			...
			listeRecherche.addFilterQuery("classeNomsCanoniques_indexed_strings:" + ClientUtils.escapeQueryChars("org.computate.site.enUS.cours.c001.l006.C001L006InstallerEclipse"));
